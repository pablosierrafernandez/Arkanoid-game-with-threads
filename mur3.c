...
int lines;
int nueva;
int ipc_nblocs,ipc_fi1,ipc_numPilotes,ipc_numPilotesReal,ipc_indexPelota;
int *p_pantalla,* p_nblocs, * p_fi1, *p_numPilotes, *p_numPilotesReal, *p_indexPelota;
int id_pantalla;
int ipc_mem;
//time_t inicio, fin;
//int t, min, seg;;
...
//char pilotas[MAX_PELOTAS][PARAMETROS_PELOTAS];
char nPilotes[10],nPilotesReal[10],s_lines[10],str_fi1[10];
